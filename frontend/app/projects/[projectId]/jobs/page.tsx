...
export default function ChallengeDashboard({ params }: { params: { projectId: string } }) {
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 20 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            <div className="card">
              ...
              >
                <Link href={`/projects/${params.projectId}/jobs/new`} className="nav-item">
                  <Icon name="upload" size={14} />
                  Submit new strategy
                </Link>
                <Link href={`/projects/${params.projectId}/leaderboard`} className="nav-item">
        ...
        <div className="card">
          <div className="card-head">
            <div>
              ...
              <div className="card-sub">Team DLQF-YOU · {SUBMISSIONS.length} total</div>
            </div>
            <Link
              href={`/projects/${params.projectId}/jobs/new`}
          ...
          <JobsTable submissions={SUBMISSIONS} />
        </div>
      )}
